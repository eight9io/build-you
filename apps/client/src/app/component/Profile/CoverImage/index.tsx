...
import { getImageFromUserDevice, uploadNewCover } from '../../../utils/uploadUserImage';
...
const CoverImage: React.FC<ICoverImageProps> = ({ src, setIsLoading }) => {
        ...
        >
          {src && (
            <>
              <Image
                className={clsx(
                  'absolute left-0  top-0  h-[115px] w-full'
                )}
